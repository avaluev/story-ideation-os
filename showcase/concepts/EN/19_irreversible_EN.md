...
[↩ Back to the slate](../../README.md) · `🟢 Grade A` · `Year-1 SOM $166M` · `Grounded prestige thriller`

`Six episodes, roughly 50–58 minutes each` · `Upper-prestige limited series (cast-and-craft heavy, effects-light)`

> **Logline** — Days before an irreversible AI deployment, the lab's top alignment engineer discovers the only clean proof her system is lethal is also a working blueprint for catastrophe — and every competent move she makes to stop it hands her employer both the weapon and the reason to ship faster.
>
> **Tagline** — *The proof is the weapon.*
