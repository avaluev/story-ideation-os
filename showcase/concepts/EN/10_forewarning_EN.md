...
[↩ Back to the slate](../../README.md) · `🟢 Grade A` · `Year-1 SOM $166M` · `Institutional thriller`

`Limited series — roughly 8 episodes, one audit cycle each, hour-long` · `Mid-market premium drama (contained production; the speculative element is paperwork, not spectacle)`

> **Logline** — A federal auditor who forecasts deaths is forbidden to warn anyone. Her next case is the stranger who once pulled her from a frozen lake — and the system has always intended her to be the hand that kills him.
>
> **Tagline** — *She can see exactly how you die. She is forbidden to tell you.*
