...
The serviceable addressable market narrows to the slice of that box office reachable by a handcrafted, painterly animated psychological thriller carrying a single-title franchise spine: roughly $39.4B. This is the band occupied by prestige-leaning, original-IP animation and elevated genre cinema that travels across language barriers — the segment where a wordless visual conceit and a two-sister emotional core can outperform the budget tier that produced them.

The serviceable obtainable market — the realistic Year-One capture for a single launched title with a distinctive hook and a built-in series engine — is **$528M**, sitting inside a modeled range of roughly $293M on the conservative floor to $950M on the optimistic ceiling, with a projected lifetime value across windows approaching $1.56B once home, streaming, and library tail are counted.
...
*The Green Mile* (1999) is the closest tonal sibling — a supernatural prison drama that turned a $60M budget into $286.8M worldwide for a 3.78x return, proving that a confinement story built on an impossible mercy can carry adult weight to a mass theatrical audience. *Batman* (1989) is the structural model for an original dark-genre property launching a durable franchise: a $35M budget returned $411.3M worldwide, a 10.75x return, on the strength of a single ownable image and a tone that refused the medium's default whimsy. Against those, the soft comparable is honest and instructive: *Teenage Mutant Ninja Turtles: Out of the Shadows* (2016) spent $135M to gross $245.6M — a 0.82x return that lost money — precisely because it leaned on franchise familiarity instead of a fresh hook. The lesson priced into this thesis is that the spend does not save a tired idea, and a sharp original one does not need the spend.
...
- **Genre:** Animated psychological prison-thriller (crime / mystery / fantasy)
...
On the morning her certification is announced, a black-hooded prisoner is delivered to her cell. When the hood comes off it is Iris — the older sister Aurelia believed dead, the woman who hid her as a baby, taught her the first trick of walking memory to survive the purges, then vanished. Warden Castellan Mott hands Aurelia the order in person: walk Iris, find the rendezvous of the Choir — a network that empties minds before the state can harvest them — and do it in nine days, or a counter-purge kills thousands. Mott is no sadist. He is a humane arithmetician who genuinely grieves the children he uses; he bred Walkers young precisely because the young walk memory without adult scar tissue, and Aurelia is his proof-of-concept. Behind the nine-day clock is a colder lever: forty more children are already being prepared for the same severance, and Aurelia's success is the blueprint that authorizes the next intake. To win is to doom them.

Aurelia acts, by choice, again and again, and the building betrays each choice as she makes it. She refuses the sanctioned break-team and walks Iris alone, off the record — and finds a room she cannot enter, sealed with her own childhood face on the door; outside the cell, a corridor she never authorized begins to grow. She forges a continuation order to keep Iris off the harvest floor, and a wall folds inward at the gesture, the prison registering the lie in its own concrete. She breaks into the Vault's growth-ledger and learns the newest wing was grown from her own erased memories — she has been walked before; the prison is partly built from her. Three deliberate, escalating crimes, each her cause, each leaving an architectural confession she cannot retract.
...
|---|---|---|---|---|---|
| [Batman](https://www.boxofficemojo.com/title/tt0096895/) | 1989 | $411.3M | $35.0M | 10.75x | Original dark-genre property launching a durable franchise on one ownable image and a tone that refused the medium's default. |
| [The Green Mile](https://www.boxofficemojo.com/title/tt0120689/) | 1999 | $286.8M | $60.0M | 3.78x | Closest tonal sibling — a supernatural prison drama carrying an impossible-mercy dilemma to a mass adult audience. |
| [F9](https://www.boxofficemojo.com/release/rl192906753/) | 2021 | $726.2M | $200.0M | 2.63x | Demonstrates the ceiling for a globally traveling crime-action franchise installment at the high budget tier. |
| [Teenage Mutant Ninja Turtles: Out of the Shadows](https://www.boxofficemojo.com/release/rl3530851841/) | 2016 | $245.6M | $135.0M | 0.82x | Honest downside case — leaned on franchise familiarity over a fresh hook and lost money; the cautionary baseline this concept is built to avoid. |
...
- **Inside Out 2 hit $1.46B, became highest-grossing animated film** — “After six weeks of release, "Inside Out 2" has generated $601 million domestically and $861 million internationally, bringing its global tally to a staggering $1.46 billion.” ([source](https://variety.com/2024/film/box-office/inside-out-2-highest-grossing-animated-film-history-1236079442/), 2024-07-28)
...
| **SOM (Year 1)** | $528M | Obtainable Year-1 revenue — `python_executed` from the matched comparable films above; 80% band $293M-$950M; lifetime $1.56B. Never model arithmetic. |
