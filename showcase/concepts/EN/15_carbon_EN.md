...
[↩ Back to the slate](../../README.md) · `🔵 Grade B` · `Year-1 SOM $538M` · `Forensic drama`

`~120 minutes` · `Lean — single primary location, small principal cast, no visual effects; festival-launch posture`

> **Logline** — A dying archaeologist must destroy her career's greatest discovery to prove a murdered ancient woman's body is telling the truth.
>
> **Tagline** — *Every layer she removes brings her closer to the one she buried.*
